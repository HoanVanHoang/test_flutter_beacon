              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    Align(alignment: Alignment.center, child: Text(state, style: TextStyle(fontSize: 30))),
                    SizedBox(height: 20),
                    Align(
                      ...
                      child: GestureDetector(
                          ...
                          if ( true) {
                            ...
                            if (Platform.isIOS) {
                              ...
                              r = new Region(
                                  identifier: uuid,
                                  proximityUUID: uuid,
                                  major: int.tryParse(maj),
                                  minor: int.tryParse(mir));
                            } else {
                              // android platform, it can ranging out of beacon that filter all of Proximity UUID
                              r = Region(identifier: 'Scanner');
                            }
                            setState(() {
                              currentRegio = r;
                              state = "Scanning";
                        ...
                        child: Container(
                          ...
                          child: Text("Scan", style: TextStyle(color: Colors.white, fontSize: 25)),
                        ),
                      ),
                    ),
                    SizedBox(height: 20),
                    Align(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          padding: EdgeInsets.symmetric(horizontal: 40, vertical: 10),
                          decoration: BoxDecoration(color: Colors.blue, borderRadius: BorderRadius.circular(15)),
                          child: Text("Stop scanner", style: TextStyle(color: Colors.white, fontSize: 25)),
                        ),
                      ),
                    ),
                    SizedBox(height: 10),
                    Align(
                        alignment: Alignment.center, child: Text("List beacon found", style: TextStyle(fontSize: 20))),
                    SizedBox(height: 10),
    ...
    return [
      ...
      Container(
        decoration: BoxDecoration(
            color: Colors.white, borderRadius: BorderRadius.circular(8.0), border: Border.all(color: Colors.grey)),
        child: TextField(
